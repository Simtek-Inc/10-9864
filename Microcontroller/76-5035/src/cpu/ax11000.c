...
// External stack pointer fixed at 0x0D //
...
//--------------------------------------------------------------------------------
// Name    : byte AX11000_GetSysClk(void)
...
//--------------------------------------------------------------------------------
// Name    : byte AX11000_GetMemSdw(void)
...
//--------------------------------------------------------------------------------
// Name    : byte AX11000_GetProgWst(void)
...
//--------------------------------------------------------------------------------
// Name    : byte AX11000_GetDataSth(void)
...
#if AX_SWRST_ENB
//--------------------------------------------------------------------------------
// Name    : void AX11000_SoftReset(void)
...
#if AX_SWRBT_ENB
//--------------------------------------------------------------------------------
// Name    : void AX11000_SoftReboot(void)
...
#if AX_WATCHDOG_ENB
//--------------------------------------------------------------------------------
// Name    : void AX11000_WatchDogSetting(byte wdIntrEnb, byte wdRstEnb, byte wdPrty, byte wdTime)
