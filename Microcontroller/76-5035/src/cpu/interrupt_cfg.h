...
//#define  AX_I2C_INT_ENABLE			0 // 1:enable I2C ISR ; 0:disable I2C ISR
...
//#define  AX_POWER_MANAGEMENT_INT_ENABLE	1 // 1:enable power management wake up  ISR ; 0:disable that
