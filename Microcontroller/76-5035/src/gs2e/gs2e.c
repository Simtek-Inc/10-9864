...
// params  :
// returns :
// notes   : Rev B removed 2 extra buffer writes that were corrputing the device status data
//----------------------------------------------------------------------------------------
void  GS2E_PortLeaseTimeoutUpdate(void)
{
...
//          if(acDimmingRequest < 0xffff)                                                   // make sure the maximum number of action requests is not pending
//            { 
//            bufDimmingData[ix02] = 0;                                                      // 
//            acDimmingRequest++;                                                           // trigger a reset action
//            }
