...
#define GS2E_STATE_IDLE                               0 
#define GS2E_STATE_TCP_DATA_PROCESS                   1
#define GS2E_STATE_UDP_DATA_PROCESS                   2

//#define GS2E_ENABLE_FLOW_CONTROL                    0     // 1:enable 0:disable
...
#define GS2E_CONN_UDP                                 1
#define GS2E_CONN_TCP                                 2
