...
#line 27 "\_SWORK\10-\9800\9864\MICROCONTROLLER\76-4415\SRC\CPU\AX11000_CFG.H" /1
...
#line 29 "src\mstimer\delay.c" /0
 ...
 static uint delay_MsLoop  =  1;
 static byte delay_SysClk  = 25;
 static byte delay_ProgWst =  1;
 ...
 {
 case 0xC0 : delay_SysClk = 100;  break;
 case 0x40  : delay_SysClk = 50;   break;
 case 0x00  : delay_SysClk = 25;   break;
 default:                                  break;
 }
 
 delay_ProgWst = AX11000_GetProgWst() + 1;
 
 delay_MsLoop = ((ulong)delay_SysClk * 1000) / ((ulong)delay_ProgWst * 44);
 }  
 ...
 void DELAY_Us(uint loop)
 {	
 ulong	count;
 
 count = ((ulong)delay_SysClk * loop) / ((ulong)delay_ProgWst * 20);
 if (count > 7)
 count -= 7;
 else
 return;
