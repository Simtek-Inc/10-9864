 ...
 begin
  case tmp.Tag of
    $01 :
      begin
        //When ON
        if cbxGraphicsEnable.Checked then IDENT.Brush.Color := clRed;
      end;

    else
      begin
        //When OFF
        if cbxGraphicsEnable.Checked then IDENT.Brush.Color := clSilver;
      end;
  end;
end;
...
begin
    ...
    $01 :
      begin
          //STBY
         if cbxGraphicsEnable.Checked then
          begin
          stby.Font.Color := clRed;
